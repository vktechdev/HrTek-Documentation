...
1. Сотрудник в личном кабинете выбирает **Заявка на получение справки о неполучении единовременного пособия при рождении ребенка** и нажимает кнопку **Создать**.
2. Для формирования документа вводит обязательные данные о ребенке — ФИО, дата рождения и прикрепляет файл свидетельства о рождении, и после нажимает кнопку **Подтвердить**.

![](./assets/Screenshot_467.png)
