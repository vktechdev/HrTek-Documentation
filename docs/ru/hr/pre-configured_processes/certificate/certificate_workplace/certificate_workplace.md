...
3. Выбирает **Заявка на получение справки с места работы**.
4. Нажимает **Создать**.
...
5. Если настройка по автоформированию справки отключена, то специалист вручную загружает документ в формате PDF. После загрузки документа нажимает кнопку **Подписать**, после чего документ будет направлен сотруднику.
