...
3. Выбирает **Заявка на получение справки 2-НДФЛ**.
3. Нажимает **Создать**.

## Этап 1. Формирование заявки на получение справки 2-НДФЛ

1. Для формирования заявки 2-НДФЛ сотрудник указывает год, за который необходимо получить справку.
5. Затем нажать **Подтвердить**.

![](./assets/9.png)

## Этап 2. Работа с процессом со стороны Бухгалтерии

### Работа через 1С

1. Бухгалтер переходит в **1С** → **КЭДО** → **Рабочее место кадровика**.
...
В **Сервисах компании**, в разделе **Заявки** открывает заявку **Заявка на получение справки 2-НДФЛ** и вручную загружает файл со справкой.  

![](./assets/Screenshot_465.png)
