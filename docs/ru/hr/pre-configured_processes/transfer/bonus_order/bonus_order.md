...
В заявке справа Сотрудник ознакамливается с приказом. В заявке указан дедлайн, до которого необходимо подписать документ — 3 дня после получения документа.
