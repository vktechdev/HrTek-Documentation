# Процесс «Заявление об изменении персональных данных»
...
- Прежние персональные данные,
- Новые персональные данные, 
- Выбор свидетельства, подтверждающего смену, 
- Серия и номер свидетельства об изменении персональных данных, 
- Указание причины изменения персональных данных.
2. Выбирает документ, подтверждающий смену персональных данных.
3. Прикрепляет скан нового паспорта.

![](./assets/Screenshot_431.png)

4. Нажимает кнопку **Перейти к предпросмотру**.

5. Проверяет заявление и нажимает кнопку **Продолжить**.
...
1. Отдел кадров переходит в **Сервисы компании в веб-сервисе**, в раздел **Заявки** и открывает нужную заявку от сотрудника.
...
6. Если специалист отдела кадров при проверке заявления не нашел ошибки, то он вручную изменяет данные в карточке сотрудника в 1С, а затем нажимает кнопку **Подтвердить** в заявке.