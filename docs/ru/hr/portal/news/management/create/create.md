...
Также в новость можно добавить мини-опрос. Для этого нажмите кнопку **Создать опрос**.

![](./assets/Create_news111.png)
...
Чтобы просмотреть добавляемую новость так, как увидят её другие пользователи сервиса, нажмите кнопку **Предпросмотр**.

![](./assets/Preview_mode1.png)
...
* **Выберите действие с новостью**. Для выбора доступны варианты:   
