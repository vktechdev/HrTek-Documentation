Пользователи с ролью **Администратор модуля Портал** могут создавать, редактировать и удалять категории сообществ в разделе **Социальные сервисы → Категории**.

Перед тем как создать сообщество, обязательно создайте хотя бы одну категорию. 

## Создание категории

Чтобы создать категорию, перейдите в раздел **Социальные сервисы → Категории**, переставьте переключатель на сервис **Сообщества** (при наличии доступа к более чем одному сервису), нажмите кнопку **Создать категорию**. 
...
Сохраните внесённые данные. Новая категория будет доступна для выбора при создании сообщества.
...
* **Статус**. Выберите один из статусов: **Активная** или **Неактивная**. Переключение статусов будет недоступно в случае, если редактируемая категория уже назначена хотя бы на одно сообщество. 
...
Если категория уже была назначена хотя бы на одно сообщество, эту категорию удалить нельзя. Чтобы удаление этой категории стало доступно, при редактировании сообщества замените в нем эту категорию на любую другую. 

![](./assets/Surveycategories-12.png)
