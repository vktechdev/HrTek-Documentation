...
* **Обложка**. Необязательное поле. Чтобы загрузить обложку, нажмите кнопку ![](./assets/skrepka.png "inline"). Далее выделите нужную область загружаемого изображения и сохраните изменения. Если обложка не загружена, то система присваивает стандартное изображение (серый фон).
...
- Допустимые форматы изображений: JPEG, PNG, HEIF, WEBP, DNG, TIFF 
- Изображение не должно превышать 10 МБ. 
- Минимальный размер изображения 1296×100 пикселей. 
...
2. **Просматривать список участников**. При включенной настройке пользователи смогут увидеть список участников сообщества.  
3. **Разрешать публиковать посты**. Настройка распространяется на участников, подписанных на сообщество, и пользователей, не вступивших в сообщество.  
4. **Модерировать посты**. При включенной настройке любой пользовательский пост будет публиковаться только после предварительной модерации.
5. **Комментировать посты**. При включенной настройке автор поста сможет разрешать комментировать пост другим пользователям.  
6. **Ставить реакции**. При включенной настройке автор поста сможет разрешать проставлять реакции к посту другим пользователям.  
