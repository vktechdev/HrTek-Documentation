...
## Завершение и результаты прохождения опроса
...
Если в настройках опроса администратор разрешил показывать ответы, то пользователь сможет посмотреть результаты прохождения опроса (кнопка **Смотреть результаты**).

![](./assets/Creatingsurvey-28.png)

Также открыть результаты можно в пользовательском разделе **Опросы**, перейдя на страницу опроса из списка.

![](./assets/Creatingsurvey-2.png)

По завершении прохождения опроса пользователю доступна статистика прохождения опроса всеми пользователями на дату и время открытия просмотра аналитики.

После истечения срока всего опроса пользователю станет доступна статистика прохождения опроса на дату и время завершения опроса.

В результатах опроса отображается следующая информация:

1. Общая информация по вопросу: вопрос, общее количество ответов на конкретный вопрос, тип вопроса, обязательность вопроса.
2. Выделены те ответы, которые дал текущий пользователь.
3. Если пользователь не ответил на какой-либо из вопросов, то вопрос будет отмечен как пропущенный.
4. Если текст вопроса был изменен, отображается актуальный текст вопроса.
5. Если текст ответа был изменен, отображается старый вариант ответа и новый. По новому варианту ведется своя аналитика. 

![](./assets/Survey-analytics.png)
