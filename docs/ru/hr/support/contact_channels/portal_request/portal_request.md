...
[Портал самообслуживания](https://support.mcs.mail.ru) является системой поддержки VK Tech и используется для обращений не только по продукту VK HR Tek, но и по другим сервисам VK Tech
