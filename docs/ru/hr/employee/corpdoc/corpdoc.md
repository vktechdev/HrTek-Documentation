...
![](./assets/Screenshot_1561.png) 

<br>

После подписания документ перейдет в статус **Проверка подписи**. Обычно проверка подписи занимает несколько секунд.
