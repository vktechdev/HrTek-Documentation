...
Для просмотра доступных дней отпуска перейдите в **Детализацию отпускных дней**. Количество дней отображается в зависимости от настройки системы:

- без округления;
- по правилам математического округления;
- с округлением в пользу сотрудника.

![](./assets/vacation.png)

<info>

Для подключения или изменения настройки параметров округления доступных дней отпуска представителю компании необходимо обратиться в [поддержку VK HR Tek](/ru/hr/support/contact_channels)
