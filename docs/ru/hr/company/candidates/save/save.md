...
Если кандидат прикладывает к анкете справку СТД-Р в формате .xml — данные из файла этого типа потом могут быть считаны в 1С автоматически

</info>

Чтобы этап **Сохранение кандидата** перешёл на этап **Завершено**, выполните следующие действия: 
...
4. В сервисе VK HR Tek, на этапе **Проверка** кандидат-заявки можно скачать все документы, которые прикрепил кандидат. Документы будут доступны для скачивания и на этапе **Сохранение кандидата**.
