...
Сотрудник должен самостоятельно подключить Telegram в **Профиле**. Компания совместно с менеджером ВК может настроить дополнительные уведомления. Для этого направьте заполненный файл [Параметры настройки уведомлений](./assets/Settings_notifications.xlsx "download") на адрес поддержки <support@hrtek.ru>.
