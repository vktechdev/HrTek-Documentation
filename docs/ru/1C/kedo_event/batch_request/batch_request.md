...
После проверки нажмите кнопку **Создать** в форме **Создание заявки** и перейдите к следующим шагам в зависимости от бизнес-процесса. На каждого сотрудника будет создана отдельная заявка. 
