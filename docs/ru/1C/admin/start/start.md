...
Расширение 1С КЭДО необходимо установить на платформу 1С, в которой ведётся кадровый учёт вашей организации. Для получения расширения, после заключения договора, обратитесь к вашему менеджеру VK HR Tek. Расширение для 1С предоставляется без дополнительной оплаты, в рамках обычных лицензий сервиса.

</warn>

<info>

Актуальная версия расширения 1С КЭДО была протестирована на платформе 1С:Предприятие 8.3.27 с конфигурацией ЗУП КОРП, ред. 3.1.38.18
