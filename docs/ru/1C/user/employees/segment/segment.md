...
5. Нажмите кнопку **Записать** или **Записать и закрыть**. Можно приступать к обработке заявок сотрудников, распределённых по сегментам (см. статью [Работа с сегментами сотрудников](/ru/1C/kedo_event/segment_hr)).

6. Если требуется очистить ячейки с сегментами, выделите строки с сотрудниками или подразделениями и нажмите кнопку **Сегмент** → **Очистить**.