...
Если выключить **Использование типа заявки**, этот тип заявки станет недоступен для создания новых заявок

</warn>

Каждый блок этапа заявки состоит из элементов:
...
Чтобы изменить масштаб схемы, нажмите кнопку !["Плюс"](./assets/plus2.png "inline") или !["Минус"](./assets/minus2.png "inline") справа от схемы процесса.
