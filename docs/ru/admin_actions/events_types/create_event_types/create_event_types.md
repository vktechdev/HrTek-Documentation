...
Чтобы процесс отобразился у менеджера VK HR Tek для дальнейшей донастройки или переноса на другие юрлица, добавьте в универсальный процесс хотя бы один дедлайн в разделе **Сервисы компании** → **Настройки** → **Типы заявок**. Подробнее о дедлайнах см. в [статье](/ru/admin_actions/events_types/managing_event_types/deadline).
