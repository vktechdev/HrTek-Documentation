...
## **Заместители видят все незавершённые заявки, а не только новые**
...
Для компании. Путь: **Настройки → Настройки компании**

![](./assets/Screenshot_4312.png)

Для аккаунта. Путь: **Настройки → Настройки аккаунта**
