...
4. Включите/отключите параметр «Использовать профили доступа для ограничения доступа к заявкам планирования графиков отпусков». По умолчанию опция отключена.
...
5. Выберите один источник для формирования списка профилей: **1С интеграция** или **Оргструктура**.

<info> 

Возможна несовместимость настройки профилей из 1С, если в КЭДО группы доступа получены не из 1С
