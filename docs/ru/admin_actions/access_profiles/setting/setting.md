...
## **Пример по формированию списка профилей и присвоению их сотрудникам с учетом настроек**

Подразделения пронумерованы от 0 до 14. Список профилей = список выбранных подразделений с учетом дочерних в рамках одного юрлица.
