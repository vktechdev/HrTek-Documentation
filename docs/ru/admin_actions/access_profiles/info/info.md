...
1. Настроить профили доступа в разделе **Настройки компании** (подробнее в [статье](/ru/admin_actions/access_profiles/setting)).
1. Для источника профилей: 1С интеграция. [Распределить сотрудников](/ru/1C/user/access_groups/division) по группам доступа в 1С (базовый функционал 1С).
