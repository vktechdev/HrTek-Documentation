...
Если созданный шаблон не устраивает, то в него можно внести изменения и сохранить еще раз. Если захотите вернуть изначальный PDF-шаблон, то обратитесь в [поддержку VK HR Tek](/ru/hr/support/contact_channels).
