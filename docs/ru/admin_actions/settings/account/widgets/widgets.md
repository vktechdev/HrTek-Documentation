...
8. Чтобы отредактировать виджеты в компании или удалить компанию из списка исключений, откройте необходимую компанию в списке.

![](./assets/unnamed7.png)

<br>

9. Нажмите кнопку **Сбросить до аккаунта** и сохраните действие.
