...
8. Чтобы отредактировать виджеты в компании, откройте необходимую компанию в списке.

![](./assets/unnamed7.png)

<br>

9. Чтобы синхронизировать компанию с аккаунтом, нажмите кнопку **Сбросить до аккаунта** и сохраните действие.
