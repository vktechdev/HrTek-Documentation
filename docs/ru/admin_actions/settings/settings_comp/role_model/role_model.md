В **Сервисы компании** → **Настройки** → **Настройки компании** возможна настройка «Использование ролевой модели». Пользователь с ролью «Администратор» может настроить доступ к разделам целиком или к конкретным данным в зависимости от роли сотрудника в компании.
...
- Общее — Оргструктура;
- Общее — Данные сотрудников в оргструктуре компании;
- Компания — Сотрудники (доступ целиком);
- Компания — Корпоративные документы (доступ целиком);
- Компания — Рабочее время (доступ целиком);
- Сотрудник — Персональные данные (доступ к отдельным данным);
- Сотрудник — Персональные данные — Дата рождения (доступ к отдельным данным);
- Сотрудник — Персональные данные — Общая информация (доступ к отдельным данным);
- Сотрудник — Персональные данные — Документы (доступ к отдельным данным);
- Сотрудник — Персональные данные — Контакты (доступ к отдельным данным);
- Сотрудник — Персональные данные — О семье (доступ к отдельным данным).
...
- все представители — пользователи, у которых есть хотя бы одна роль в компании;
